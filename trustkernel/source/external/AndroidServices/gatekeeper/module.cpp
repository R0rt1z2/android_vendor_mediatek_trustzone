...
using gatekeeper::TrustKernelGateKeeperDevice;
...
static int gatekeeper_open(const hw_module_t *module, const char *name,
    ...
    TrustKernelGateKeeperDevice *gatekeeper = new TrustKernelGateKeeperDevice(module);
...
struct gatekeeper_module HAL_MODULE_INFO_SYM __attribute__((visibility("default"))) = {
    .common = {
        ...
        .name = "TrustKernel GateKeeper HAL",
        .author = "TrustKernel",

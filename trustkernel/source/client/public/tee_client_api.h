 ...
 * 
 * TEEC_MEMREF_PERMANENT	  The Registered Memory Reference structure that 
 * 							  is permanently shared (zero-copy) between REE and TEE
 */
...
TEEC_Result TEEC_TUIInitialize(TEEC_Session *session, TEEC_Operation *operation);

TEEC_Result TEEC_TUIFinalize(TEEC_Session *session);
